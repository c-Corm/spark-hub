...
const SEED_TASKS = [
  ...
  { id: 2,  category: "Before Event",   text: "Review the full SPARK 2026 agenda for all three days", done: false },
  ...
  { id: 7, category: "Friday 7/24",    text: "Welcome attendees at Check-In (12PM–8PM) and direct to registration", done: false },
  { id: 8, category: "Friday 7/24",    text: "Help set the tone at the First Time at SPARK Mixer (3:00–3:45PM)", done: false },
  { id: 9, category: "Friday 7/24",    text: "Introduce attendees to each other and foster connections all evening", done: false },
  { id: 10, category: "Saturday 7/25",  text: "Assist with SPARK Check-In (7:30–8:30AM) and direct attendees", done: false },
  { id: 11, category: "Saturday 7/25",  text: "Help with Breakfast setup and greeting people (7:30–8:30AM)", done: false },
  { id: 11, category: "Saturday 7/25",  text: "Have breakfast with someone you don't know", done: false },
  { id: 12, category: "Saturday 7/25",  text: "Facilitate smooth transitions between sessions and stretch breaks", done: false },
  { id: 13, category: "Saturday 7/25",  text: "Assist with Kids Activity during lunch (1:30–2:30PM)", done: false },
  { id: 11, category: "Saturday 7/25",  text: "Have lunch with someone you don't know", done: false },
  { id: 14, category: "Saturday 7/25",  text: "Assist with Prize Drawing at end of evening (9:00PM)", done: false },
  { id: 15, category: "Saturday 7/25",  text: "Capture photos and share to the official SPARK 2026 hashtag", done: false },
  { id: 16, category: "Sunday 7/26",    text: "Help with Breakfast flow and meeting new people (8–9:15AM)", done: false },
  { id: 17, category: "Sunday 7/26",    text: "Support Sunday Presentations — room management and attendee assistance", done: false },
  { id: 18, category: "Sunday 7/26",    text: "Assist with Empower & Engage interactive session (12:05–12:45PM)", done: false },
  { id: 19, category: "Sunday 7/26",    text: "Be present for Closing Remarks and help wrap up (12:45–12:50PM)", done: false },
  { id: 20, category: "After Event",    text: "Help with breakdown and direct attendees to exits and parking", done: false },
